...
def make_settings(**overrides) -> Settings:
    defaults = dict(
        ...
        auth_static_projects=("default",),
        auth_static_roles=("cogito-viewer", "cogito-approver"),
        auth_oidc_issuer="",
        auth_oidc_audience="",
        auth_oidc_jwks_url="",
        auth_oidc_role_claim="roles",
        auth_oidc_product_manager_role="cogito-product-manager",
        auth_oidc_approval_role="cogito-approver",
        auth_oidc_workflow_approver_role="cogito-workflow-approver",
        auth_oidc_policy_editor_role="cogito-policy-editor",
        auth_oidc_policy_publisher_role="cogito-policy-publisher",
        auth_oidc_project_claim="cogito_projects",
        auth_oidc_viewer_role="cogito-viewer",
